  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--line)] bg-[var(--bg)]/85 backdrop-blur-md">
      <Shell className="flex items-center justify-between px-6 py-3 sm:px-8">
        ...
        >
          <span className="font-serif text-xl tracking-wide text-[var(--fg)]">{site.firstName}</span>
          <span className="font-mono text-[11px] text-[var(--soft)] tracking-wide">/an · i · mesh/</span>
        </Link>
